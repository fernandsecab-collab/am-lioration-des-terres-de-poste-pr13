# RC31 — Mesure & amélioration des terres de poste de transformation
...
- L’onglet Diagnostic & Solutions n’affiche plus que les solutions dont la simulation donne **c < 0,150**.
...
## V137
Le rapport explique désormais pourquoi la solution retenue fonctionne, avec une lecture client, une justification professionnelle, la référence EDF B13-23 et la réserve de validation par mesures finales.
